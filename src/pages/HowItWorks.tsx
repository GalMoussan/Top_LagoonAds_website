		...
		<div className="space-y-12">
			<header className="space-y-3 max-w-2xl">
				...
				<p className="text-sm sm:text-base text-slate-300">
					LagoonAds keeps the complexity under the surface. For you, it&apos;s a
					simple flow: plug in your traffic or offers, and we handle routing,
					...
					{steps.map((step, idx) => (
						...
						>
							<div className="flex items-center md:flex-col md:items-center md:pt-1">
								<div className="h-8 w-8 rounded-2xl bg-gradient-to-br from-lagoon-blue to-lagoon-turquoise flex items-center justify-center text-xs font-semibold text-slate-950 shadow-soft mr-3 md:mr-0">
									{idx + 1}
								</div>
							</div>
							<div className="rounded-3xl bg-slate-950/70 border border-white/5 p-4 hover:border-lagoon-blue/60 transition-colors">
			...
			{/* Final CTA banner */}
			<section className="rounded-4xl border border-lagoon-blue/40 bg-gradient-to-r from-lagoon-blue/20 via-lagoon-turquoise/15 to-slate-950 shadow-soft p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-4">
				<div>
					<h2 className="text-xl sm:text-2xl font-semibold text-slate-50">
						Ready to plug into LagoonAds?
					</h2>
					<p className="text-sm text-slate-200 mt-1 max-w-md">
						Whether you&apos;re an affiliate with traffic or an advertiser with
						offers, we&apos;ll guide you through a quick, human onboarding
						process.
					</p>
				</div>
